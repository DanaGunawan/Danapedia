            ...
            <div class="row">
                ...
                <aside class="col-lg-3 order-lg-first">
                    <form action="" method="post" class="filterForm">
                        <input type="text" name="sub_category" id="get_sub_category_id">
                        <input type="text" name="get_brands" id="get_brand_id">
                        <input type="text" name="get_colors" id="get_color_id">
                        <input type="text" name="get_sort" id="get_sort_by_id">
                    </form>
                            ...
                            <div class="widget-body">
                                <div class="filter-colors">
                                    @foreach ($getColor as $color_f)
                                        <a href="javascript:;" class="ChangeColor" id="{{ $color_f->id }}" data-val="0"  style="background: {{ $color_f->code }};"><span
                                                class="sr-only">
                                                {{ $color_f->name }}</span></a>
                                    @endforeach
